...
from TripleGAN_10 import TripleGAN_10
...
def parse_args():
    ...
    parser.add_argument('--test_batch_size', type=int, default=64, help='The size of unlabel batch')
...
def main():
    ...
    with tf.compat.v1.Session(config=tf.compat.v1.ConfigProto(allow_soft_placement=True)) as sess:
        gan = TripleGAN_10(sess, epoch=args.epoch, batch_size=args.batch_size, test_batch_size =args.test_batch_size, unlabel_batch_size=args.unlabel_batch_size,
                        z_dim=args.z_dim,  n=args.n, gan_lr = args.gan_lr, cla_lr = args.cla_lr,
